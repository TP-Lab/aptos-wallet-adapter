...
export class TokenPocketWallet implements AdapterPlugin {
  ...
  provider: TokenPocketProvider | undefined =
    typeof window !== "undefined" ? window.tokenpocket?.aptos : undefined;
  ...
  async signTransaction(
    ...
    try {
      const response = await this.provider?.signTransaction(transaction, options);
